...
import com.xuxiang.pj.entity.User;
...
public class Utils {
    ...
    public static String getIMEI(Context context) {
        ...
        String uniqueId = MD5Util.MD5Encode(deviceUuid.toString(), null);
...
//                Context.TELEPHONY_SERVICE)).getDeviceId();
    ...
    public static SpannableString setDifTvColoc(Context context, String showText, int start, int end) {
        ...
        msp.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.white)), 0, start, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        msp.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.black)), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        msp.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.white)), end, showText.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return msp;
    }
